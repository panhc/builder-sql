...
class Builder {
    ...
    clone() {
        let newBuilder = new Builder(this._query.tableName);
        newBuilder._query = JSON.parse(JSON.stringify(this._query));
        return newBuilder;
    }
    ...
    where(...params) {
        ...
        switch (params.length) {
            ...
            case 2:
                ...
                break;
            case 3:
                params[2] = typeof params[2] === 'string' ? `'${params[2]}'` : params[2];
    ...
    toSql() {
        ...
        if(this._query.fields.length){
            this._query.fields.push('*');
        }
